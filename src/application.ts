...
command.usage( '[options] [path-to-the-package]' )
  ...
  .option( '-d, --dark-colors', 'use dark colors (preset) for displaying the treeview' )
  .option( '-b, --bright-colors', 'use bright colors (preset) for displaying the treeview' )
  .option( '-c, --custom-colors', 'use custom colors for displaying the treeview' )
